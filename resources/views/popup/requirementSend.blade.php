...
<div id="requirementUpload-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="realtive p-4 w-full max-w-xl max-h-full">
        <div class="relative bg-bgprimary rounded-lg shadow dark:bg-gray-700">
            <button type="button" class="absolute top-3 end-2.5 text-red-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="requirementUpload-modal">
            ...
            <div class="p-4 md:p-5 text-center">
                <i class="fa-sharp fa-regular fa-circle-check mx-auto mb-2 text-gray-400 w-12 h-12 text-5xl text-white"></i>
               
                <h3 class="text-lg font-normal text-white dark:text-gray-400 uppercase">Upload your requirements to ETEEAP.</h3>
                <span class="text-white"><i class="fa-solid fa-asterisk text-red-500"></i> REQUIRED TO SUBMIT</span>
                <div class="">
                   
                    <form class="max-w-lg mx-auto text-black border h-115 overflow-auto" enctype="multipart/form-data" action="{{ route('store') }}" method="post">
                        @csrf
                        <div class="mb-2 border bg-white rounded-md p-1">
                        ...
                        <div class="mb-2 border bg-white rounded-md p-1">
                            <label class="block mb-2 text-md text-left font-bold text-bgprimary" for="ce">2.CHED - ETEEAP: <i class="fa-solid fa-asterisk text-red-500"></i></label>
                            ...
                            <div class="mt-1 text-sm text-left uppercase text-bgprimary dark:text-gray-300" id="user_avatar_help">Application form with 3 pieces of 1x1 picture </div>
                        </div>
