...
<div class="w-full max-w-sm p-4 bg-bgprimary border border-bgprimary rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
    <form class="space-y-6" action="{{ route('login') }}" method="POST">
        @csrf
        <h5 class="text-xl font-medium text-textprimary dark:text-white">Sign in to our platform</h5>
        <div>
        ...
        <div class="flex items-start">
            ...
            <a href="#" class="ms-auto text-sm text-textprimary hover:underline dark:text-blue-500">Lost Password?</a>
        </div>
