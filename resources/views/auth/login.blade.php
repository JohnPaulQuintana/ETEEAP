<x-guest-layout>
    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h2 class="text-title-md2 font-bold text-blue-900 dark:text-white">
                Sign In
            </h2>
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    <li>
                        <a class="font-medium text-blue-900" href="index.html">ETEEAP /</a>
                    </li>
                    <li class="font-medium text-blue-900">Sign In</li>
                </ol>
            </nav>
        </div>
        <!-- Breadcrumb End -->
        ...
        <div class="rounded-sm  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div class="flex flex-wrap items-center">
                ...
                <div class="hidden w-full xl:block xl:w-1/2 overflow-hidden">
                    <iframe src="{{ asset('requirement/Qualification-and-Requirements.pdf') }}" frameborder="0" width="100%" height="710"></iframe>
                    {{-- <div class="px-26 py-17.5 text-center">
                        <a class="mb-5.5 inline-block" href="index.html">
                            <img class="dark:hidden" src="{{ asset('images/logo.png') }}" alt="Logo" />
                        </a>

                        <p class="font-bold text-blue-900 uppercase 2xl:px-20">
                ...
                <div class="w-full border border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                    <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                        <div class="px-10 text-center mb-10">
                            <a class="mb-1.5 inline-block" href="index.html">
                                <img class="w-40" src="{{ asset('images/logo.png') }}" alt="Logo" />
                            </a>
    
                            <p class="b-9 text-sm font-bold text-blue-900 dark:text-white sm:text-title-md">
                                Application Tracking System for ETEEAP
                            </p>
                        ...
                        <form  method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-5">
                                <input type="submit" value="Sign In"
                                    class="w-full cursor-pointer rounded-lg border border-primary bg-blue-800 p-4 font-medium text-white transition hover:bg-opacity-90" />
                            </div>
