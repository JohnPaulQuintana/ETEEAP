<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a href="{{ route('user-dashboard') }}" class="flex flex-col items-center gap-2">
            ...
            <span class="text-white">Application Tracking System</span>
        </a>
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
            ...
            <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
                ...
                <div>
                    ...
                    <ul class="mb-6 flex flex-col gap-1.5">
                        ...
                        <li>
                            <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                                href="{{ route('department') }}" @click="selected = (selected === 'Department' ? '':'Department')"
                                :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Department') && (page === 'department') }"
                                :class="page === 'department' && 'bg-graydark'">
        ...
        @elseif (Auth::user()->role == 2)
            ...
            <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
                <!-- Menu Group -->
                <div>
                    <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark2">Application</h3>
